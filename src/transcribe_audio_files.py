...
audio_file_path = (
    # ".build/combined_final.wav"
    "data/signatures/samarth.wav"
)
definition = {"locales": ["en-US"], "diarization": {"maxSpeakers": 2, "enabled": True}}
...
if response.status_code == 200:
    for i in utils.parse_speaker_text(response.json()):
        print(i, end="\n\n")
else:
